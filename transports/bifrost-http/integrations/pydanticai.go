...
func NewPydanticAIRouter(client *meridian.Bifrost, handlerStore lib.HandlerStore, logger schemas.Logger) *PydanticAIRouter {
	routes := []RouteConfig{}
...
func ensurePydanticResponsesStreamTextFields(resp *schemas.BifrostResponsesStreamResponse) {
	...
	case schemas.ResponsesStreamResponseTypeOutputTextDelta:
		if resp.Delta == nil {
			resp.Delta = meridian.Ptr("")
		}
	case schemas.ResponsesStreamResponseTypeOutputTextDone:
		if resp.Text == nil {
			resp.Text = meridian.Ptr("")
		}
	}
}
