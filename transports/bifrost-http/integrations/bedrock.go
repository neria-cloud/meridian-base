...
func NewBedrockRouter(client *meridian.Bifrost, handlerStore lib.HandlerStore, logger schemas.Logger) *BedrockRouter {
...
func s3PutObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	...
	ctx.Response.Header.Set("x-amz-request-id", "meridian")
