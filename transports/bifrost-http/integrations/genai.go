...
const isGeminiEmbedContentRequestContextKey schemas.BifrostContextKey = "meridian-is-gemini-embed-content-request"

const isGeminiVideoGenerationRequestContextKey schemas.BifrostContextKey = "meridian-is-gemini-video-generation-request"

const isGeminiBatchCreateRequestContextKey schemas.BifrostContextKey = "meridian-is-gemini-batch-create-request"

const requestedGeminiModelMetadataContextKey schemas.BifrostContextKey = "meridian-requested-gemini-model-metadata"

const genAIRawRequestBodyContextKey schemas.BifrostContextKey = "meridian-genai-raw-request-body"
...
func NewGenAIRouter(client *meridian.Bifrost, handlerStore lib.HandlerStore, logger schemas.Logger) *GenAIRouter {
