...
import (
	...
	configtables "github.com/neria-cloud/meridian-base/framework/configstore/tables"
...
const testIssuer = "https://meridian.test"
	...
	cases := []struct {
		...
		},
		{
			...
			raw: func() string {
				...
				payload := base64.RawURLEncoding.EncodeToString([]byte(`{"iss":"https://meridian.test","aud":["https://bifrost.test/mcp"],"sub":"vk-123","bf_mode":"vk","iat":1700000000,"nbf":1700000000,"exp":9999999999}`))
