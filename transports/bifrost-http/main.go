...
import (
	...
	"github.com/neria-cloud/meridian-base/transports/bifrost-http/profiling"
	bifrostServer "github.com/neria-cloud/meridian-base/transports/bifrost-http/server"
)
...
var logger = meridian.NewDefaultLogger(schemas.LogLevelInfo)
...
`, versionLine)
	...
	logger.Info("Time spent in Meridian server bootstrap %d ms", time.Since(t).Milliseconds())
	err = server.Start()
	if err != nil {
