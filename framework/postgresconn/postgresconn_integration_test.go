...
func newPasswordCommandTestConfig(t *testing.T, cacheTTL string) (*Config, string) {
	...
	return &Config{
		...
		User:            schemas.NewSecretVar(getenvDefault("BIFROST_POSTGRES_PASSWORD_COMMAND_TEST_USER", "meridian")),
		DBName:          schemas.NewSecretVar(getenvDefault("BIFROST_POSTGRES_PASSWORD_COMMAND_TEST_DB", "meridian")),
