...
Usage:
    python bundle.py                    # Output to openapi.json (next to openapi.yaml)
    python bundle.py --output spec.json # Output to custom file
    python bundle.py --format yaml      # Output as YAML

Meridian: `bifrost-prep genspec` reads openapi.json and generates the Go
package framework/pluginshttp from it; run this script after editing the YAML.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Output file path (default: openapi.json next to openapi.yaml)",
    )
    parser.add_argument(
