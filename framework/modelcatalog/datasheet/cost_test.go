...
func chatPricing(input, output float64) configstoreTables.TableModelPricing {
	return configstoreTables.TableModelPricing{
		...
		Mode:               "chat",
		InputCostPerToken:  meridian.Ptr(input),
		OutputCostPerToken: meridian.Ptr(output),
	}
}
...
func TestComputeTextCost_WithCachedPromptTokens(t *testing.T) {
	...
	p.CacheReadInputTokenCost = meridian.Ptr(0.0000003)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000375)
...
func gpt56SolPricing() configstoreTables.TableModelPricing {
	...
	p.InputCostPerTokenAbove272kTokens = meridian.Ptr(0.00001)
	p.InputCostPerTokenFlex = meridian.Ptr(0.0000025)
	p.InputCostPerTokenFlexAbove272kTokens = meridian.Ptr(0.000005)
	p.InputCostPerTokenPriority = meridian.Ptr(0.00001)
	p.OutputCostPerTokenAbove272kTokens = meridian.Ptr(0.000045)
	p.OutputCostPerTokenFlex = meridian.Ptr(0.000015)
	p.OutputCostPerTokenFlexAbove272kTokens = meridian.Ptr(0.0000225)
	p.OutputCostPerTokenPriority = meridian.Ptr(0.00006)
	p.CacheReadInputTokenCost = meridian.Ptr(0.0000005)
	p.CacheReadInputTokenCostAbove272kTokens = meridian.Ptr(0.000001)
	p.CacheReadInputTokenCostFlex = meridian.Ptr(0.00000025)
	p.CacheReadInputTokenCostFlexAbove272kTokens = meridian.Ptr(0.0000005)
	p.CacheReadInputTokenCostPriority = meridian.Ptr(0.000001)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000625)
	p.CacheCreationInputTokenCostAbove272kTokens = meridian.Ptr(0.0000125)
	p.CacheCreationInputTokenCostFlex = meridian.Ptr(0.000003125)
	p.CacheCreationInputTokenCostFlexAbove272kTokens = meridian.Ptr(0.00000625)
	p.CacheCreationInputTokenCostPriority = meridian.Ptr(0.0000125)
	return p
}
...
func TestComputeTextCost_FastMode(t *testing.T) {
	...
	p.InputCostPerTokenFast = meridian.Ptr(0.00001)
	p.OutputCostPerTokenFast = meridian.Ptr(0.00005)
...
func TestComputeTextCost_FastMode_FlatAcrossContextWindow(t *testing.T) {
	...
	p.InputCostPerTokenFast = meridian.Ptr(0.00001)
	p.OutputCostPerTokenFast = meridian.Ptr(0.00005)
	p.InputCostPerTokenAbove200kTokens = meridian.Ptr(0.0000075)
	p.OutputCostPerTokenAbove200kTokens = meridian.Ptr(0.0000375)
...
func TestComputeTextCost_FastMode_UsesFastCacheRates(t *testing.T) {
	...
	p.InputCostPerTokenFast = meridian.Ptr(0.00001)
	p.OutputCostPerTokenFast = meridian.Ptr(0.00005)
	p.CacheReadInputTokenCost = meridian.Ptr(0.0000005)         // standard read (ignored in fast)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000625)    // standard 5m write (ignored in fast)
	p.CacheReadInputTokenCostFast = meridian.Ptr(0.000001)      // fast read
	p.CacheCreationInputTokenCostFast = meridian.Ptr(0.0000125) // fast 5m write
...
func TestComputeTextCost_InferenceGeoUS_AppliesMultiplier(t *testing.T) {
	...
	p.CacheReadInputTokenCost = meridian.Ptr(0.000001)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.0000125)
	p.SearchContextCostPerQuery = meridian.Ptr(0.01)
	p.InferenceGeoUSMultiplier = meridian.Ptr(1.1)
	...
	usage := &schemas.BifrostLLMUsage{
		...
		CompletionTokensDetails: &schemas.ChatCompletionTokensDetails{
			NumSearchQueries: meridian.Ptr(2),
		},
	}
...
func TestTierFromResponse_Speed(t *testing.T) {
	...
	assert.False(t, tierFromResponse(nil, meridian.Ptr("standard"), nil).isFast)
	assert.True(t, tierFromResponse(nil, meridian.Ptr("fast"), nil).isFast)
}

func TestTierFromResponse_InferenceGeo(t *testing.T) {
	assert.False(t, tierFromResponse(nil, nil, nil).inferenceGeoUS)
	assert.False(t, tierFromResponse(nil, nil, meridian.Ptr("global")).inferenceGeoUS)
	assert.True(t, tierFromResponse(nil, nil, meridian.Ptr("us")).inferenceGeoUS)
	assert.True(t, tierFromResponse(nil, nil, meridian.Ptr("US")).inferenceGeoUS)
}
...
func TestComputeTextCost_With1hrCacheCreationTokens(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.CacheReadInputTokenCost = meridian.Ptr(3e-7)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove1hr = meridian.Ptr(0.0000075)
...
func TestComputeTextCost_1hrCacheCreationFallsBackToStandardWhenAbove1hrRateAbsent(t *testing.T) {
	...
	p.CacheReadInputTokenCost = meridian.Ptr(8e-8)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.000001)
...
func TestComputeTextCost_CacheWriteTokenDetailsNil_FallsBackToStandardCreationRate(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove1hr = meridian.Ptr(0.0000075) // present but must not be used
...
func TestComputeTextCost_1hrCacheCreationAbove200k_UsesAbove1hrAbove200kRate(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.InputCostPerTokenAbove200kTokens = meridian.Ptr(0.000006)
	p.OutputCostPerTokenAbove200kTokens = meridian.Ptr(0.00003)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove200kTokens = meridian.Ptr(0.0000075)
	p.CacheCreationInputTokenCostAbove1hr = meridian.Ptr(0.0000075)
	p.CacheCreationInputTokenCostAbove1hrAbove200kTokens = meridian.Ptr(0.000015)
...
func TestComputeTextCost_1hrCacheCreationAbove200k_FallsBackToAbove1hrWhenAbove200kRateAbsent(t *testing.T) {
	...
	p.CacheCreationInputTokenCost = meridian.Ptr(0.00000375)
	p.CacheCreationInputTokenCostAbove200kTokens = meridian.Ptr(0.0000075)
	p.CacheCreationInputTokenCostAbove1hr = meridian.Ptr(0.000009) // distinct from above_200k to make fallback unambiguous
...
func TestComputeTextCost_1hrCacheCreationAbove200k_FallsBackToStandardAbove200kWhenNo1hrRates(t *testing.T) {
	...
	p := chatPricing(8e-7, 0.000004)
	p.InputCostPerTokenAbove200kTokens = meridian.Ptr(0.0000016)
	p.OutputCostPerTokenAbove200kTokens = meridian.Ptr(0.000008)
	p.CacheCreationInputTokenCost = meridian.Ptr(0.000001)
	p.CacheCreationInputTokenCostAbove200kTokens = meridian.Ptr(0.000002)
...
func TestComputeTextCost_SearchQueryCost(t *testing.T) {
	p := chatPricing(0.000003, 0.000015)
	p.SearchContextCostPerQuery = meridian.Ptr(0.01) // $0.01 per search query
...
func TestComputeEmbeddingCost_Basic(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  meridian.Ptr(0.0000001),
		OutputCostPerToken: meridian.Ptr(0.0),
	}
	usage := &schemas.BifrostLLMUsage{
		PromptTokens: 5000,
		TotalTokens:  5000,
...
func TestComputeEmbeddingCost_TotalAbove200kButInputBelow200kUsesBaseRate(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:                meridian.Ptr(0.000003),
		InputCostPerTokenAbove200kTokens: meridian.Ptr(0.000006),
	}
	usage := &schemas.BifrostLLMUsage{
		PromptTokens: 180000,
		TotalTokens:  210000,
...
func TestComputeRerankCost_Basic(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  meridian.Ptr(0.000001),
		OutputCostPerToken: meridian.Ptr(0.000002),
	}
	usage := &schemas.BifrostLLMUsage{
		PromptTokens:     2000,
		CompletionTokens: 100,
...
func TestComputeRerankCost_WithSearchCost(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:         meridian.Ptr(0.0),
		OutputCostPerToken:        meridian.Ptr(0.0),
		SearchContextCostPerQuery: meridian.Ptr(0.001),
	}
	numQueries := 5
	usage := &schemas.BifrostLLMUsage{
		CompletionTokensDetails: &schemas.ChatCompletionTokensDetails{
...
func TestComputeSpeechCost_TokensPreferredOverDuration(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   meridian.Ptr(0.0000025),
		OutputCostPerToken:  meridian.Ptr(0.00001),
		OutputCostPerSecond: meridian.Ptr(0.00025),
	}
	seconds := 60
	usage := &schemas.BifrostLLMUsage{
		PromptTokens:     100,
...
func TestComputeSpeechCost_OutputFallsBackToPerSecond(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   meridian.Ptr(0.000001),
		OutputCostPerToken:  meridian.Ptr(0.000002),
		OutputCostPerSecond: meridian.Ptr(0.0001),
	}
	seconds := 120
...
func TestComputeSpeechCost_OutputAudioTokenRate(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:       meridian.Ptr(0.000001),
		OutputCostPerToken:      meridian.Ptr(0.000002),
		OutputCostPerAudioToken: meridian.Ptr(0.00005),
	}
	usage := &schemas.BifrostLLMUsage{
		PromptTokens:     200,
		CompletionTokens: 100,
...
func TestComputeTranscriptionCost_DurationBased(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  meridian.Ptr(0.0),
		OutputCostPerToken: meridian.Ptr(0.0),
		InputCostPerSecond: meridian.Ptr(0.00010278),
	}
...
func TestComputeTranscriptionCost_AudioTokenDetails(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:      meridian.Ptr(0.000005),
		OutputCostPerToken:     meridian.Ptr(0.000015),
		InputCostPerAudioToken: meridian.Ptr(0.00001),
	}
	usage := &schemas.BifrostLLMUsage{
		PromptTokens:     2000,
		CompletionTokens: 500,
...
func TestComputeTranscriptionCost_TokenDetailsPreferredOverDuration(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:          meridian.Ptr(0.000005),
		OutputCostPerToken:         meridian.Ptr(0.0),
		InputCostPerAudioPerSecond: meridian.Ptr(0.0001),
		InputCostPerAudioToken:     meridian.Ptr(0.00001),
	}
	seconds := 60
	audioDetails := &schemas.TranscriptionUsageInputTokenDetails{
...
func TestComputeImageCost_PerImage(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  meridian.Ptr(0.0),
		OutputCostPerToken: meridian.Ptr(0.0),
		OutputCostPerImage: meridian.Ptr(0.052),
	}
...
func TestComputeImageCost_DoesNotUseBareTotalTokensAsInputTierTokens(t *testing.T) {
	p := chatPricing(0.000003, 0.000015)
	p.OutputCostPerImage = meridian.Ptr(0.05)
	p.OutputCostPerTokenAbove200kTokens = meridian.Ptr(0.00003)
	usage := &schemas.ImageUsage{
...
func TestComputeImageCost_InputAndOutputPerImage(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerImage:  meridian.Ptr(0.01),
		OutputCostPerImage: meridian.Ptr(0.05),
	}
	usage := &schemas.ImageUsage{
		NumInputImages:      3,
...
func TestComputeImageCost_PerPixelOutput(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerPixel: meridian.Ptr(0.000000019), // ~$0.02 for 1024x1024
	}
	usage := &schemas.ImageUsage{
...
func TestComputeImageCost_PerPixelInputAndOutput(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerPixel:  meridian.Ptr(0.00000001),
		OutputCostPerPixel: meridian.Ptr(0.00000002),
	}
	usage := &schemas.ImageUsage{
		NumInputImages:      2,
...
func TestComputeImageCost_PixelsPreferredOverPerImage(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerPixel: meridian.Ptr(0.00000002),
		OutputCostPerImage: meridian.Ptr(999.0), // should not be used
	}
	usage := &schemas.ImageUsage{
		OutputTokensDetails: &schemas.ImageTokenDetails{NImages: 1},
	}
...
func TestComputeImageCost_QualityBasedRates(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		OutputCostPerImage:              meridian.Ptr(0.01),
		OutputCostPerImageLowQuality:    meridian.Ptr(0.02),
		OutputCostPerImageMediumQuality: meridian.Ptr(0.03),
		OutputCostPerImageHighQuality:   meridian.Ptr(0.04),
		OutputCostPerImageAutoQuality:   meridian.Ptr(0.05),
	}
...
func TestComputeVideoCost_DurationBased(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:           meridian.Ptr(0.000001),
		OutputCostPerToken:          meridian.Ptr(0.0),
		OutputCostPerVideoPerSecond: meridian.Ptr(0.001),
	}
	seconds := 30
...
func TestComputeVideoCost_OutputCostPerSecondFallback(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   meridian.Ptr(0.0),
		OutputCostPerToken:  meridian.Ptr(0.0),
		OutputCostPerSecond: meridian.Ptr(0.002),
	}
	seconds := 10
...
func TestTieredOutputRate_AboveThreshold(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerToken:                meridian.Ptr(0.000015),
		OutputCostPerTokenAbove200kTokens: meridian.Ptr(0.00003),
	}
	...
	resp := &schemas.BifrostResponse{
		TranscriptionResponse: &schemas.BifrostTranscriptionResponse{
			Usage: &schemas.TranscriptionUsage{
				Seconds:      &sec,
				InputTokens:  meridian.Ptr(1000),
				OutputTokens: meridian.Ptr(200),
				TotalTokens:  meridian.Ptr(1200),
			},
		},
	}
	input := extractCostInput(resp)
...
func TestCalculateCost_SemanticCacheDirectHit(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			...
			InputCostPerToken: meridian.Ptr(0.000005), OutputCostPerToken: meridian.Ptr(0.000015),
		},
	})
...
func TestCalculateCost_SemanticCacheSemanticHit(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("text-embedding-3-small", "openai", "embedding"): {
			...
			InputCostPerToken: meridian.Ptr(0.00000002),
		},
	})
...
func TestCalculateCost_ChatCompletion_GPT4o(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			...
			InputCostPerToken:       meridian.Ptr(0.000005),
			OutputCostPerToken:      meridian.Ptr(0.000015),
			CacheReadInputTokenCost: meridian.Ptr(0.0000005),
		},
	})
...
func TestCalculateCost_ChatCompletion_Claude35Sonnet_WithCache(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("anthropic.claude-3-5-sonnet-20241022-v2:0", "bedrock", "chat"): {
			...
			InputCostPerToken:                 meridian.Ptr(0.000003),
			OutputCostPerToken:                meridian.Ptr(0.000015),
			CacheReadInputTokenCost:           meridian.Ptr(0.0000003),
			CacheCreationInputTokenCost:       meridian.Ptr(0.00000375),
			InputCostPerTokenAbove200kTokens:  meridian.Ptr(0.000006),
			OutputCostPerTokenAbove200kTokens: meridian.Ptr(0.00003),
		},
	})
...
func TestCalculateCost_TogetherAliasUsesTogetherAIPricingWithCache(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey(model, "together_ai", "chat"): {
			...
			Mode:                    "chat",
			InputCostPerToken:       meridian.Ptr(1.40 / 1_000_000),
			CacheReadInputTokenCost: meridian.Ptr(0.26 / 1_000_000),
			OutputCostPerToken:      meridian.Ptr(4.40 / 1_000_000),
		},
	})
	usage := &schemas.BifrostLLMUsage{
...
func TestGetPricing_GeminiFallsBackToVertex(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gemini-2.0-flash", "vertex", "chat"): {
			...
			InputCostPerToken: meridian.Ptr(0.0000001), OutputCostPerToken: meridian.Ptr(0.0000004),
		},
	})
...
func TestCalculateCost_200kTier_EndToEnd(t *testing.T) {
	...
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("anthropic.claude-3-5-sonnet-20240620-v1:0", "bedrock", "chat"): {
			...
			CacheReadInputTokenCost:                    meridian.Ptr(0.0000003),
			CacheCreationInputTokenCost:                meridian.Ptr(0.00000375),
			CacheReadInputTokenCostAbove200kTokens:     meridian.Ptr(0.0000006),
			CacheCreationInputTokenCostAbove200kTokens: meridian.Ptr(0.0000075),
		},
	})
...
func TestCalculateCost_ImageGeneration_NilUsage_PerImagePricing(t *testing.T) {
	...
	pricing := configstoreTables.TableModelPricing{
		...
		InputCostPerToken:  meridian.Ptr(0.0),
		OutputCostPerImage: meridian.Ptr(0.04),
	}
...
func TestComputeContainerCreationCost_Basic(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		...
		Provider:                      "openai",
		Mode:                          "chat",
		CodeInterpreterCostPerSession: meridian.Ptr(0.03),
	}
...
func TestCalculateCost_ContainerCreate_MemorySpecificEntry(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("container-4g", "openai", "chat"): {
			...
			Provider:                      "openai",
			Mode:                          "chat",
			CodeInterpreterCostPerSession: meridian.Ptr(0.12),
		},
	})
...
func TestCalculateCost_BackCompat_RoutingInfoWinsOverLegacyFields(t *testing.T) {
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("gemini-2.0-flash", "gemini", "chat"): {
			...
			Mode:               "chat",
			InputCostPerToken:  meridian.Ptr(0.0000001),
			OutputCostPerToken: meridian.Ptr(0.0000004),
		},
	})
...
func TestCalculateCostForUsage_AppliesServedTier(t *testing.T) {
	...
	p.InputCostPerTokenFast = meridian.Ptr(0.00001)
	p.OutputCostPerTokenFast = meridian.Ptr(0.00003)
	p.InferenceGeoUSMultiplier = meridian.Ptr(1.1)
	s := testStoreWithPricing(map[string]configstoreTables.TableModelPricing{
...
func TestTieredCacheCreationRate_PriorityWinsOver200kBand(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		CacheCreationInputTokenCost:                meridian.Ptr(0.000001),
		CacheCreationInputTokenCostAbove200kTokens: meridian.Ptr(0.000002), // standard >200k — must NOT win for priority
		CacheCreationInputTokenCostPriority:        meridian.Ptr(0.000005), // flat priority — must win
	}
...
func seedFallbackPricing(s *Store) {
	s.pricingData[makeKey("claude-fable-5", "anthropic", "responses")] = configstoreTables.TableModelPricing{
		...
		InputCostPerToken:  meridian.Ptr(10.0 / 1_000_000),
		OutputCostPerToken: meridian.Ptr(50.0 / 1_000_000),
	}
	s.pricingData[makeKey("claude-opus-4-8", "anthropic", "responses")] = configstoreTables.TableModelPricing{
		...
		InputCostPerToken:  meridian.Ptr(5.0 / 1_000_000),
		OutputCostPerToken: meridian.Ptr(25.0 / 1_000_000),
	}
}
...
func TestCalculateCost_ServerSideFallback_PricesServingModel(t *testing.T) {
	...
	resp := fallbackResponse(meridian.Ptr("claude-opus-4-8"), 31, 257)
...
func TestCalculateCost_ServerSideFallback_UnknownServingModelFallsThrough(t *testing.T) {
	...
	resp := fallbackResponse(meridian.Ptr("claude-not-in-catalog"), 31, 257)
	cost := s.CalculateCost(resp, nil)
...
func TestCalculateCost_ServerSideFallback_OutranksKeyAlias(t *testing.T) {
	...
	resp.ResponsesResponse.ExtraFields.RoutingInfo.ResolvedKeyAlias = &schemas.ResolvedKeyAlias{
		...
		ModelName: meridian.Ptr("claude-fable-5"),
	}
...
func TestCalculateCostForUsage_ServerSideFallback_PricesServingModel(t *testing.T) {
	...
	usage := &schemas.BifrostLLMUsage{
		...
		TotalTokens:             383,
		ServerSideFallbackModel: meridian.Ptr("claude-opus-4-8"),
	}
