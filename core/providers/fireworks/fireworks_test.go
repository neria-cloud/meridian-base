...
import (
	...
	fireworksprovider "github.com/neria-cloud/meridian-base/core/providers/fireworks"
...
func resolveFireworksModels(t *testing.T, client *meridian.Bifrost, ctx context.Context) (string, string, string) {
	t.Helper()
...
func fireworksModelSupportsTextCompletions(t *testing.T, client *meridian.Bifrost, ctx context.Context, model string) bool {
	t.Helper()
...
func fireworksModelSupportsEmbeddings(t *testing.T, client *meridian.Bifrost, ctx context.Context, model string) bool {
	t.Helper()
