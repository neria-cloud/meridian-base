...
func TestGenAISafetyRatingsAvgLogprobsResponseID_PersistThroughBifrostRoundTrip(t *testing.T) {
	...
	bifrostResp := geminiResp.ToResponsesBifrostResponsesResponse()
	require.NotNil(t, bifrostResp)
	require.NotNil(t, bifrostResp.ProviderExtraFields, "safetyRatings/avgLogprobs/responseId must be captured in ProviderExtraFields since Meridian's Responses schema has no field for them")
