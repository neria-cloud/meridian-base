...
import (
	...
	"github.com/neria-cloud/meridian-base/core/keyselectors"
	"github.com/neria-cloud/meridian-base/core/mcp"
	"github.com/neria-cloud/meridian-base/core/mcp/codemode/starlark"
	"github.com/neria-cloud/meridian-base/core/mcp/credstore"
	"github.com/neria-cloud/meridian-base/core/providers/anthropic"
	"github.com/neria-cloud/meridian-base/core/providers/azure"
	"github.com/neria-cloud/meridian-base/core/providers/bedrock"
	"github.com/neria-cloud/meridian-base/core/providers/bedrockmantle"
	"github.com/neria-cloud/meridian-base/core/providers/cerebras"
	"github.com/neria-cloud/meridian-base/core/providers/cohere"
	"github.com/neria-cloud/meridian-base/core/providers/deepseek"
	"github.com/neria-cloud/meridian-base/core/providers/elevenlabs"
	"github.com/neria-cloud/meridian-base/core/providers/fireworks"
	"github.com/neria-cloud/meridian-base/core/providers/gemini"
	"github.com/neria-cloud/meridian-base/core/providers/groq"
	"github.com/neria-cloud/meridian-base/core/providers/huggingface"
	"github.com/neria-cloud/meridian-base/core/providers/mistral"
	"github.com/neria-cloud/meridian-base/core/providers/nebius"
	"github.com/neria-cloud/meridian-base/core/providers/ollama"
	"github.com/neria-cloud/meridian-base/core/providers/openai"
	"github.com/neria-cloud/meridian-base/core/providers/opencode"
	"github.com/neria-cloud/meridian-base/core/providers/openrouter"
	"github.com/neria-cloud/meridian-base/core/providers/parasail"
	"github.com/neria-cloud/meridian-base/core/providers/perplexity"
	"github.com/neria-cloud/meridian-base/core/providers/replicate"
	"github.com/neria-cloud/meridian-base/core/providers/runware"
	"github.com/neria-cloud/meridian-base/core/providers/runway"
	"github.com/neria-cloud/meridian-base/core/providers/sarvam"
	"github.com/neria-cloud/meridian-base/core/providers/sgl"
	providerUtils "github.com/neria-cloud/meridian-base/core/providers/utils"
	"github.com/neria-cloud/meridian-base/core/providers/vertex"
	"github.com/neria-cloud/meridian-base/core/providers/vllm"
	"github.com/neria-cloud/meridian-base/core/providers/wafer"
	"github.com/neria-cloud/meridian-base/core/providers/xai"
...
func Init(ctx context.Context, config schemas.BifrostConfig) (*Bifrost, error) {
	if config.Account == nil {
		return nil, fmt.Errorf("account is required to initialize Meridian")
	}
...
func (bifrost *Bifrost) ExecuteChatMCPTool(ctx *schemas.BifrostContext, toolCall *schemas.ChatAssistantMessageToolCall) (*schemas.ChatMessage, *schemas.BifrostError) {
	...
	if bifrost.MCPManager == nil {
		return nil, &schemas.BifrostError{
			IsBifrostError: false,
			Error:          &schemas.ErrorField{Message: "mcp is not configured in this meridian instance"},
	...
	if err := bifrost.removeProviderFromSlice(providerKey); err != nil {
		bifrost.logger.Error(
			"provider %s was removed from queues but could not be removed from the providers slice — "+
				"meridian.providers is now inconsistent. "+
				"To recover: retry RemoveProvider(%s), or restart Meridian if that fails.",
...
func (bifrost *Bifrost) UpdateProvider(providerKey schemas.ModelProvider) error {
	...
	if bifrost.ctx.Err() != nil {
		return fmt.Errorf("meridian is shutting down")
	}
...
func (bifrost *Bifrost) RegisterMCPTool(name, description string, handler func(args any) (string, error), toolSchema schemas.ChatTool) error {
	if bifrost.MCPManager == nil {
		return fmt.Errorf("mcp is not configured in this meridian instance")
	}
...
func (bifrost *Bifrost) GetMCPClients() ([]schemas.MCPClient, error) {
	if bifrost.MCPManager == nil {
		return nil, fmt.Errorf("mcp is not configured in this meridian instance")
	}
...
func (bifrost *Bifrost) RunStreamPreHooks(ctx *schemas.BifrostContext, req *schemas.BifrostRequest) (*WSStreamHooks, *schemas.BifrostError) {
	...
	if preReq == nil && shortCircuit == nil {
		bifrostErr := newBifrostErrorFromMsg("meridian request after plugin hooks cannot be nil")
...
func executeRequestWithRetries[T any](
	...
	defer func() {
		...
		case bifrostError.IsBifrostError:
			ctx.AppendRoutingEngineLog(schemas.RoutingEngineCore, schemas.LogLevelError, fmt.Sprintf("Retries halted for %s/%s after %d attempt(s): internal Meridian error (%s)", providerKey, model, attempts, routingErrorSummary(bifrostError)))
...
func (bifrost *Bifrost) getAllSupportedKeys(ctx *schemas.BifrostContext, providerKey schemas.ModelProvider, baseProviderType schemas.ModelProvider) ([]schemas.Key, error) {
	...
	bifrost.logger.Debug("[Meridian] Provider %s: %d valid keys found", providerKey, len(supportedKeys))
