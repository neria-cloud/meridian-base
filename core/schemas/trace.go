...
const (
	...
	TraceAttrDimensions = "meridian.dimensions"
)
...
const (
	...
	// OTel MCP semconv.
	AttrBifrostMCPToolDurationMs = "meridian.mcp.tool.duration_ms"
	...
	AttrBifrostUpstreamDurationMs = "meridian.upstream.duration_ms"
	...
	// never disagree.
	AttrBifrostOverheadDurationMs = "meridian.overhead.duration_ms"

	AttrBifrostProviderName        = "meridian.provider.name"
	AttrBifrostRequestID           = "meridian.request.id"
	AttrBifrostVirtualKeyID        = "meridian.virtual_key.id"
	AttrBifrostVirtualKeyName      = "meridian.virtual_key.name"
	AttrBifrostSelectedKeyID       = "meridian.selected_key.id"
	AttrBifrostSelectedKeyName     = "meridian.selected_key.name"
	AttrBifrostRoutingRuleID       = "meridian.routing_rule.id"
	AttrBifrostRoutingRuleName     = "meridian.routing_rule.name"
	AttrBifrostTeamID              = "meridian.team.id"
	AttrBifrostTeamName            = "meridian.team.name"
	AttrBifrostCustomerID          = "meridian.customer.id"
	AttrBifrostCustomerName        = "meridian.customer.name"
	AttrBifrostBusinessUnitID      = "meridian.business_unit.id"
	AttrBifrostBusinessUnitName    = "meridian.business_unit.name"
	AttrBifrostTeamIDs             = "meridian.team.ids"
	AttrBifrostTeamNames           = "meridian.team.names"
	AttrBifrostCustomerIDs         = "meridian.customer.ids"
	AttrBifrostCustomerNames       = "meridian.customer.names"
	AttrBifrostBusinessUnitIDs     = "meridian.business_unit.ids"
	AttrBifrostBusinessUnitNames   = "meridian.business_unit.names"
	AttrBifrostUserID              = "meridian.user.id"
	AttrBifrostUserName            = "meridian.user.name"
	AttrBifrostUserEmail           = "meridian.user.email"
	AttrBifrostRetries             = "meridian.retries"
	AttrBifrostFallbackIndex       = "meridian.fallback_index"
	AttrBifrostAlias               = "meridian.alias"               // original requested model when it differs from the resolved model
	AttrBifrostRoutingEngineUsed   = "meridian.routing_engine_used" // comma-joined routing engines that handled the request
	AttrBifrostStopSequencesJoined = "meridian.request.stop_sequences"
