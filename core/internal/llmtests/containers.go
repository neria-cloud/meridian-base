...
func RunContainerCreateTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunContainerListTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunContainerRetrieveTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerRetrieve", func(t *testing.T) {
		...
		createRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-retrieve",
		}
...
func RunContainerDeleteTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerDelete", func(t *testing.T) {
		...
		createRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-delete",
		}
...
func RunContainerUnsupportedTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunContainerFileCreateTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileCreate", func(t *testing.T) {
		...
		containerRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-file-create",
		}
		...
		testContent := []byte("Hello, Meridian! This is a test file for container file operations.")
...
func RunContainerFileListTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileList", func(t *testing.T) {
		...
		containerRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-file-list",
		}
...
func RunContainerFileRetrieveTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileRetrieve", func(t *testing.T) {
		...
		containerRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-file-retrieve",
		}
...
func RunContainerFileContentTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileContent", func(t *testing.T) {
		...
		containerRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-file-content",
		}
	...
	testContent := []byte("Hello, Meridian! This is test content for file content retrieval.")
...
func RunContainerFileDeleteTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileDelete", func(t *testing.T) {
		...
		containerRequest := &schemas.BifrostContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "meridian-test-container-file-delete",
		}
...
func RunContainerFileUnsupportedTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
