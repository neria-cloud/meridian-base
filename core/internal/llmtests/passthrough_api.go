...
func buildPassthroughChatReq(t *testing.T, provider schemas.ModelProvider, model string, stream bool) (passthroughChatReq, bool) {
	...
	case schemas.OpenAI:
		...
		if stream {
			nativeReq.Stream = meridian.Ptr(true)
		}
...
func RunPassthroughAPITest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
