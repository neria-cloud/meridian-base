...
func RunCompleteEnd2EndTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("CompleteEnd2End", func(t *testing.T) {
			...
			chatReq := &schemas.BifrostChatRequest{
				...
				Params: &schemas.ChatParameters{
					...
					ToolChoice: &schemas.ChatToolChoice{
						ChatToolChoiceStr: meridian.Ptr(string(schemas.ChatToolChoiceTypeRequired)),
					},
			...
			responsesReq := &schemas.BifrostResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					...
					ToolChoice: &schemas.ResponsesToolChoice{
						ResponsesToolChoiceStr: meridian.Ptr(string(schemas.ResponsesToolChoiceTypeRequired)),
					},
		...
		responsesOperation2 := func() (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
			...
			responsesReq := &schemas.BifrostResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					MaxOutputTokens: meridian.Ptr(400),
				},
			}
			return client.ResponsesRequest(bfCtx, responsesReq)
		}
		...
		responsesOperation3 := func() (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
			...
			responsesReq := &schemas.BifrostResponsesRequest{
				...
				Input:    responsesConversationHistory,
				Params: &schemas.ResponsesParameters{
					MaxOutputTokens: meridian.Ptr(600),
				},
			}
			return client.ResponsesRequest(bfCtx, responsesReq)
		}
