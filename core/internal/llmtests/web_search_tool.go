...
func RunWebSearchToolTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
		...
		webSearchTool := &schemas.ResponsesTool{
			...
			ResponsesToolWebSearch: &schemas.ResponsesToolWebSearch{
				UserLocation: &schemas.ResponsesToolWebSearchUserLocation{
					Type:    meridian.Ptr("approximate"),
					Country: meridian.Ptr("US"),
					City:    meridian.Ptr("New York"),
				},
			},
		}
...
func RunWebSearchToolStreamTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.WebSearchTool {
		t.Logf("Web search tool not supported for provider %s", testConfig.Provider)
		return
	}
	...
	t.Run("WebSearchToolStream", func(t *testing.T) {
		...
		webSearchTool := &schemas.ResponsesTool{
			...
			ResponsesToolWebSearch: &schemas.ResponsesToolWebSearch{
				UserLocation: &schemas.ResponsesToolWebSearchUserLocation{
					Type:     meridian.Ptr("approximate"),
					Country:  meridian.Ptr("US"),
					City:     meridian.Ptr("San Francisco"),
					Region:   meridian.Ptr("California"),
					Timezone: meridian.Ptr("America/Los_Angeles"),
				},
			},
		}
		...
		request := &schemas.BifrostResponsesRequest{
			...
			Params: &schemas.ResponsesParameters{
				Tools:           []schemas.ResponsesTool{*webSearchTool},
				MaxOutputTokens: meridian.Ptr(1500),
			},
			Fallbacks: testConfig.Fallbacks,
		}
...
func RunWebSearchToolWithDomainsTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.WebSearchTool {
		t.Logf("Web search tool not supported for provider %s", testConfig.Provider)
		return
	}
	...
	t.Run("WebSearchToolWithDomains", func(t *testing.T) {
		...
		responsesOperation := func() (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
			...
			responsesReq := &schemas.BifrostResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					Tools:           []schemas.ResponsesTool{*webSearchTool},
					MaxOutputTokens: meridian.Ptr(1200),
				},
				Fallbacks: testConfig.Fallbacks,
			}
...
func RunWebSearchToolContextSizesTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.WebSearchTool {
		t.Logf("Web search tool not supported for provider %s", testConfig.Provider)
		return
	}
...
func RunWebSearchToolMultiTurnTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.WebSearchTool {
		t.Logf("Web search tool not supported for provider %s", testConfig.Provider)
		return
	}
...
func RunWebSearchToolMaxUsesTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.WebSearchTool {
		t.Logf("Web search tool not supported for provider %s", testConfig.Provider)
		return
	}
	...
	t.Run("WebSearchToolMaxUses", func(t *testing.T) {
		...
		responsesOperation := func() (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
			...
			responsesReq := &schemas.BifrostResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					Tools:           []schemas.ResponsesTool{*webSearchTool},
					MaxOutputTokens: meridian.Ptr(2000),
				},
				Fallbacks: testConfig.Fallbacks,
			}
