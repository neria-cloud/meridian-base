...
type TestScenarioFunc func(*testing.T, *meridian.Bifrost, context.Context, ComprehensiveTestConfig)

// RunAllComprehensiveTests executes all comprehensive test scenarios for a given configuration
func RunAllComprehensiveTests(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
