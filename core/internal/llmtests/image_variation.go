...
func RunImageVariationTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
		...
		imageVariationOperation := func() (*schemas.BifrostImageGenerationResponse, *schemas.BifrostError) {
			request := &schemas.BifrostImageVariationRequest{
				...
				Params: &schemas.ImageVariationParameters{
					...
					N:    meridian.Ptr(2), // Generate 2 variations
				},
...
func RunImageVariationStreamTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
