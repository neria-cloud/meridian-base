...
func RunImageEditTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
		...
		imageEditOperation := func() (*schemas.BifrostImageGenerationResponse, *schemas.BifrostError) {
			request := &schemas.BifrostImageEditRequest{
				...
				Params: &schemas.ImageEditParameters{
					Size: meridian.Ptr("1024x1024"),
					N:    meridian.Ptr(1),
					Type: meridian.Ptr("inpainting"),
					Mask: maskBytes,
				},
...
func RunImageEditStreamTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
