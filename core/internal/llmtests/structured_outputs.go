...
func RunStructuredOutputChatTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func testStructuredOutputChatWithValue(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig, expectValue bool) {
	...
	chatOperation := func() (*schemas.BifrostChatResponse, *schemas.BifrostError) {
		...
		chatReq := &schemas.BifrostChatRequest{
			...
			Params: &schemas.ChatParameters{
				MaxCompletionTokens: meridian.Ptr(5000),
...
func RunStructuredOutputChatStreamTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunStructuredOutputResponsesTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.StructuredOutputs {
		t.Logf("Structured outputs not supported for provider %s", testConfig.Provider)
		return
	}
		...
		responsesOperation := func() (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
			...
			responsesReq := &schemas.BifrostResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					MaxOutputTokens: meridian.Ptr(5000),
...
func RunStructuredOutputResponsesStreamTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.StructuredOutputs || !testConfig.Scenarios.CompletionStream {
		t.Logf("Structured outputs streaming not supported for provider %s", testConfig.Provider)
		return
	}
