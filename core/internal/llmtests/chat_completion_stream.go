...
func RunChatCompletionStreamTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ChatCompletionStream", func(t *testing.T) {
		...
		request := &schemas.BifrostChatRequest{
			...
			Params: &schemas.ChatParameters{
				MaxCompletionTokens: meridian.Ptr(1000),
			},
