...
func RunVideoGenerationTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRetrieveTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRemixTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoDownloadTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoListTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoList", func(t *testing.T) {
		...
		req := &schemas.BifrostVideoListRequest{
			Provider: testConfig.Provider,
			Order:    meridian.Ptr(order),
			Limit:    meridian.Ptr(limit),
		}
		bfCtx := schemas.NewBifrostContext(ctx, schemas.NoDeadline)
...
func RunVideoDeleteTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoUnsupportedTest(t *testing.T, client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func createVideoJob(client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig) (*schemas.BifrostVideoGenerationResponse, *schemas.BifrostError) {
...
func retrieveVideoWithRetries(client *meridian.Bifrost, ctx context.Context, testConfig ComprehensiveTestConfig, videoID string) (*schemas.BifrostVideoGenerationResponse, *schemas.BifrostError) {
