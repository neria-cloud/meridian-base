...
func TestPerServerTimeout_OverridesGlobal(t *testing.T) {
	...
	if bifrostErr != nil && bifrostErr.Error != nil {
		...
		t.Errorf("expected either a meridian error or a result indicating timeout, got both nil")
	}
}
...
func TestPerServerTimeout_FallsBackToGlobal(t *testing.T) {
	...
	if bifrostErr != nil && bifrostErr.Error != nil {
		...
		t.Errorf("expected either a meridian error or a result indicating cancellation, got both nil")
	}
}
