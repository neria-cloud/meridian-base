...
const PRICING_URL = process.env.BIFROST_PRICING_URL || 'https://meridian.neria.cloud/datasheet';
...
async function verifyCostingRequest(db, reqId, name, results, silent) {
  ...
  if (!silent) {
    ...
    console.log(`[dbverify]     expected $ : ${expectedStr}    (recomputed from meridian.neria.cloud/datasheet)`);
