...
if (censusError) {
  ...
  lines.push("> **:rotating_light: Coverage accounting FAILED.** The expected-cell census could not be loaded:");
  lines.push(`> \`${censusError}\``);
  lines.push("> Every `Expected` and `Missing` figure below is therefore 0 by default, and a backend whose");
  lines.push("> cells all errored will not appear at all. Treat this report as unable to account for coverage,");
