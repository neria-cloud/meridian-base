...
func TestMaximLoggerPlugin(t *testing.T) {
		...
		Input: []schemas.ChatMessage{
			{
				...
				Content: &schemas.ChatMessageContent{
					ContentStr: meridian.Ptr("Hello, how are you?"),
				},
			},
		},
	})
	...
	if bifrostErr != nil {
		log.Printf("Error in Meridian request: %v", bifrostErr)
	}

	log.Println("Meridian request completed, check your Maxim Dashboard for the trace")
