		...
		Input: []schemas.ChatMessage{
			{
				...
				Content: &schemas.ChatMessageContent{
					ContentStr: meridian.Ptr("Hello, test message"),
				},
			},
		},
	})
				...
				Responses: []Response{
					{
						...
						Error: &ErrorResponse{
							...
							Type:       meridian.Ptr("rate_limit"),
							Code:       meridian.Ptr("429"),
							StatusCode: meridian.Ptr(429),
						},
					},
				},
			},
				...
				Responses: []Response{
					{
						Type: ResponseTypeSuccess,
						Content: &SuccessResponse{
							MessageTemplate: meridian.Ptr("Hello from {{provider}} using model {{model}}"),
						},
					},
				},
			},
