			...
			for i := 0; i < tc.messages; i++ {
				...
				message := schemas.ChatMessage{
					...
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Message " + strconv.Itoa(i+1)),
					},
				}
...
func TestExcludeSystemPromptWithMultipleSystemMessages(t *testing.T) {
	...
	conversation1 := []schemas.ChatMessage{
		{
			...
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("You are helpful")},
		},
		{
			Role:    schemas.ChatMessageRoleSystem,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("Be concise")},
		},
		{
			Role:    schemas.ChatMessageRoleUser,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("Hello")},
		},
		{
			Role:    schemas.ChatMessageRoleAssistant,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("Hi!")},
		},
	}
	...
	conversation2 := []schemas.ChatMessage{
		{
			Role:    schemas.ChatMessageRoleSystem,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("You are an expert")},
		},
		{
			Role:    schemas.ChatMessageRoleSystem,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("Be detailed")},
		},
		{
			Role:    schemas.ChatMessageRoleUser,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("Hello")},
...
func TestExcludeSystemPromptWithNoSystemMessages(t *testing.T) {
	...
	conversation := []schemas.ChatMessage{
		...
		{
			Role:    schemas.ChatMessageRoleAssistant,
			Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("Hi there!")},
		},
	}
