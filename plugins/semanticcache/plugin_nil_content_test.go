					...
					Input: []schemas.ChatMessage{
						{
							...
							Content: &schemas.ChatMessageContent{
								ContentStr: meridian.Ptr("Call the get_weather function"),
							},
						},
						{
							...
							ChatAssistantMessage: &schemas.ChatAssistantMessage{
								ToolCalls: []schemas.ChatAssistantMessageToolCall{
									{
										ID:   meridian.Ptr("call_123"),
										Type: meridian.Ptr("function"),
										Function: schemas.ChatAssistantMessageToolCallFunction{
											Name:      meridian.Ptr("get_weather"),
			...
			Input: []schemas.ResponsesMessage{
				{
					...
					Content: &schemas.ResponsesMessageContent{
						ContentStr: meridian.Ptr("How many tokens is this message?"),
					},
				},
			},
		},
...
func createResponsesRequestWithNilContent() *schemas.BifrostResponsesRequest {
	return &schemas.BifrostResponsesRequest{
		...
		Params: &schemas.ResponsesParameters{
			Temperature:     meridian.Ptr(0.7),
			MaxOutputTokens: meridian.Ptr(100),
		},
	}
}
