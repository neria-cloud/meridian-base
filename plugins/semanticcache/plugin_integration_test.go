			...
			Input: []schemas.ChatMessage{
				{
					...
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Hello, world!"),
					},
				},
			},
			Params: &schemas.ChatParameters{
				Temperature:         meridian.Ptr(0.7),
			...
			Choices: []schemas.BifrostResponseChoice{
				{
					...
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							...
							Content: &schemas.ChatMessageContent{
								ContentStr: meridian.Ptr("Hello! How can I help you today?"),
							}},
					},
				},
			},
...
func TestSemanticCacheStrictFiltering(t *testing.T) {
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("What is the weather like?"),
					},
				},
			},
			Params: &schemas.ChatParameters{
			...
			Choices: []schemas.BifrostResponseChoice{
				{
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							Role: schemas.ChatMessageRoleAssistant,
							Content: &schemas.ChatMessageContent{
								ContentStr: meridian.Ptr("It's sunny today!"),
							}},
					},
				},
			},
	...
	modifiedRequest := &schemas.BifrostRequest{
		...
		ChatRequest: &schemas.BifrostChatRequest{
			...
			Params: &schemas.ChatParameters{
				Temperature:         meridian.Ptr(0.5), // Different temperature
				MaxCompletionTokens: meridian.Ptr(100),
			},
		},
	}
...
func TestSemanticCacheStreamingFlow(t *testing.T) {
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Tell me a short story"),
					},
				},
			},
			Params: &schemas.ChatParameters{
				Temperature: meridian.Ptr(0.8),
			},
		},
	}
	...
	for i, chunk := range chunks {
		...
		if isFinal {
			finishReason = meridian.Ptr("stop")
		}
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Test message"),
					},
				},
			},
		},
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("TTL test message"),
					},
				},
			},
		},
			...
			Choices: []schemas.BifrostResponseChoice{
				{
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							Role: "assistant",
							Content: &schemas.ChatMessageContent{
								ContentStr: meridian.Ptr("TTL test response"),
							},
						},
					},
				},
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Threshold test message"),
					},
				},
			},
		},
		...
		ChatResponse: &schemas.BifrostChatResponse{
			...
			Choices: []schemas.BifrostResponseChoice{{
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
					Message: &schemas.ChatMessage{
						Role:    "assistant",
						Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("seed response")},
					},
				},
			}},
			ExtraFields: schemas.BifrostResponseExtraFields{
...
func TestSemanticCache_ProviderModelCachingFlags(t *testing.T) {
	...
	setup.Config.CacheByProvider = meridian.Ptr(false)
	setup.Config.CacheByModel = meridian.Ptr(false)
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Provider model flags test"),
					},
				},
			},
		},
			...
			Choices: []schemas.BifrostResponseChoice{
				{
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							Role: "assistant",
							Content: &schemas.ChatMessageContent{
								ContentStr: meridian.Ptr("Provider model test response"),
							},
						},
					},
				},
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Provider model flags test"), // Same content
					},
				},
			},
		},
...
func TestSemanticCache_ConfigurationEdgeCases(t *testing.T) {
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: meridian.Ptr("Edge case test"),
					},
				},
			},
		},
	...
	res := &schemas.BifrostResponse{
		ChatResponse: &schemas.BifrostChatResponse{
			...
			Choices: []schemas.BifrostResponseChoice{{
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
					Message: &schemas.ChatMessage{Role: "assistant", Content: &schemas.ChatMessageContent{ContentStr: meridian.Ptr("ok")}},
				},
			}},
