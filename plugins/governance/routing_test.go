...
import (
	...
	"github.com/neria-cloud/meridian-base/framework/routing"
...
func TestEvaluateRoutingRules_GlobalRuleMatches(t *testing.T) {
	...
	rule := &configstoreTables.TableRoutingRule{
		...
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("azure"), Model: meridian.Ptr("gpt-4-turbo"), Weight: 1.0},
		},
		Enabled:  meridian.Ptr(true),
		Scope:    "global",
		Priority: 0,
	}
...
func TestEvaluateRoutingRules_MultiTargetDeterministicWithPinnedKey(t *testing.T) {
	...
	rule := &configstoreTables.TableRoutingRule{
		...
		Targets: []configstoreTables.TableRoutingTarget{
			{
				Provider: meridian.Ptr("azure"),
				Model:    meridian.Ptr("gpt-4-turbo"),
				KeyID:    meridian.Ptr(pinnedKeyID),
				Weight:   1.0,
			},
			{
				Provider: meridian.Ptr("openai"),
				Model:    meridian.Ptr("gpt-3.5"),
				Weight:   0.0,
			},
		},
		Enabled:  meridian.Ptr(true),
...
func TestEvaluateRoutingRules_ScopePrecedence(t *testing.T) {
	...
	globalRule := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("openai"), Model: meridian.Ptr("gpt-4o"), Weight: 1.0},
		},
		Enabled:  meridian.Ptr(true),
		Scope:    "global",
		Priority: 0,
...
func TestEvaluateRoutingRules_ChainRuleReEvaluation(t *testing.T) {
	...
	ruleA := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("openai"), Model: meridian.Ptr("gpt-4-turbo"), Weight: 1.0},
		},
		Enabled:   meridian.Ptr(true),
		Scope:     "global",
		Priority:  0,
	...
	ruleB := &configstoreTables.TableRoutingRule{
		...
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("azure"), Model: meridian.Ptr("gpt-4"), Weight: 1.0},
		},
		Enabled:   meridian.Ptr(true),
		Scope:     "global",
		Priority:  1,
...
func TestEvaluateRoutingRules_SelfLoopContinuesToNextRule(t *testing.T) {
	...
	ruleB := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("anthropic"), Model: meridian.Ptr("claude-3"), Weight: 1.0},
		},
		Enabled:   meridian.Ptr(true),
		Scope:     "global",
		Priority:  1,
...
func TestCompileAndCacheProgram_ValidExpression_Routing(t *testing.T) {
	...
	rule := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("openai"), Weight: 1.0},
		},
		Enabled: meridian.Ptr(true),
	}
...
func TestEvaluateRoutingRules_VirtualKeyPreemptsUser(t *testing.T) {
	...
	userRule := &configstoreTables.TableRoutingRule{
		...
		CelExpression: "model == 'gpt-4o'",
		Targets: []configstoreTables.TableRoutingTarget{
			{Provider: meridian.Ptr("openai"), Model: meridian.Ptr("gpt-4o-mini"), Weight: 1.0},
		},
		Enabled:  meridian.Ptr(true),
		Scope:    "user",
		ScopeID:  meridian.Ptr("user-1"),
